...
void Game::LoadData()
{
	...
	// Create the "far back" background and set textures
...
SDL_Texture *Game::GetTexture(const std::string &fileName)
{
	...
	else
	{
		...
		tex = IMG_LoadTexture(mRenderer, fullpath.c_str());
		if (!tex)
		{
			SDL_Log("Failed to load image file %s: %s", fileName.c_str(), SDL_GetError());
			return nullptr;
		}
